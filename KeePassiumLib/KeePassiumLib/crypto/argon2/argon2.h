...
typedef enum Argon2_ErrorCodes {
    ...
    ARGON2_INTERRUPTED = -100 // [AP] hashing has been interrupted by the progress callback
} argon2_error_codes;
 ...
 * @param  t  iterations done so far (out of t_cost)
 * @param  swift_obj  any Swift object passed to argon2_hash()
 * @return zero to continue hashing, anyhing else to stop and return ARGON2_INTERRUPTED
 */
typedef int (*progress_fptr)(uint32_t t, const void *swift_obj);
